...
const wordList = [
    ...
    "macho", "feixe", "gueto", "brasa", "trigo", "borda", "cetim", "parvo", "voilà", "rezao",
    "tumba", "prata", "casal", "frase", "dardo", "sadia", "trava", "sonda", "aliar", "trova",
    "bingo", "tufao", "gabar", "praga", "magro", "nervo", "filme", "fobia", "nessa", "areia",
    "traga", "perto", "caldo", "farol", "lento", "boçal", "vazao", "cifra", "parca", "caida",
    ...
    "ninho", "praia", "gole", "barba", "fecho", "perua", "limpo", "secar", "falsa", "corvo",
    ...
    "harpa", "manco", "selim", "lesão", "gêmea", "roçar", "ponta", "hifen", "ilesa", "presa",
